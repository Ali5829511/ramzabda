...
pay_status_map = {'success': 'completed', 'pending': 'pending'}
...
for _, row in df.iterrows():
    ...
    method_ar = s(row['paymentMethod'])
    method = pay_method_map.get(method_ar, 'bank_transfer')
...
# Write all blocks
with open(r'C:\Users\aliay\.verdent\verdent-projects\RAMZABDAE\contracts_block.txt', 'w', encoding='utf-8') as f:
    f.write(',\n'.join(contracts_lines))
with open(r'C:\Users\aliay\.verdent\verdent-projects\RAMZABDAE\invoices_block.txt', 'w', encoding='utf-8') as f:
    f.write(',\n'.join(invoices_lines))
with open(r'C:\Users\aliay\.verdent\verdent-projects\RAMZABDAE\installments_block.txt', 'w', encoding='utf-8') as f:
    f.write(',\n'.join(installments_lines))
with open(r'C:\Users\aliay\.verdent\verdent-projects\RAMZABDAE\payments_block.txt', 'w', encoding='utf-8') as f:
    f.write(',\n'.join(payments_lines))

print(f'Contracts:    {len(contracts_lines)}')
print(f'Invoices:     {len(invoices_lines)}')
print(f'Installments: {len(installments_lines)}')
print(f'Payments:     {len(payments_lines)}')
